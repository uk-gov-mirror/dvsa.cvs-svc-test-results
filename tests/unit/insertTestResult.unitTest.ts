              ...
              context('with an invalid recalls object value present', () => {
                  it('should throw validation error', () => {
                      ...
                      try {
                          ...
                          expect(error.body).toEqual({
                              "errors": [
                                  "\"recalls\" must be of type object"
                              ]
                          });
                      }
                  });
              });
              context('with an invalid hasRecall value in recalls object present', () => {
                  it('should throw validation error', () => {
                      ...
                      try {
                          ...
                          expect(error.body).toEqual({
                              "errors": [
                                  "\"recalls.hasRecall\" must be a boolean"
                              ]
                          });
                      }
                  });
              ...
              context('with hasRecall missing from recalls object', () => {
                  it('should throw validation error', () => {
                      ...
                      try {
                          ...
                          expect(error.body).toEqual({
                              "errors": [
                                  "\"recalls.hasRecall\" is required"
                              ]
                          });
                      }
                  });
              });
              context('with an invalid manufacture value in recalls object present', () => {
                  it('should throw validation error', () => {
                      ...
                      try {
                          ...
                          expect(error.body).toEqual({
                              "errors": [
                                  "\"recalls.manufacturer\" must be a string"
                              ]
                          });
                      }
                  });
